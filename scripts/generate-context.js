...
w("> 🔗 **Live App:** [https://meal-balancer-three.vercel.app/](https://meal-balancer-three.vercel.app/)");
w();
w("---");
w();
...
w("## 11. Persistence");
w();
w("- **User plans** → `localStorage` key: `meal-balancer-user-plans`");
...
w("## 17. Deployment");
w();
w("- **Live URL**: [https://meal-balancer-three.vercel.app/](https://meal-balancer-three.vercel.app/)");
