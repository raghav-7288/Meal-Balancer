...
// Snapshot any OAuth redirect error from the URL as early as possible, before
// supabase-js's async session detection can strip it from the hash.
import "./lib/oauthError";
